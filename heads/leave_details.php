...
<?php
	...
	{ $did=intval($_GET['leaveid']);
		...
		$sql = "SELECT tblemployees.compensatory_casual_leave from tblleaves join tblemployees on tblleaves.empid=tblemployees.emp_id where tblleaves.id=:lid";
		$query = $dbh -> prepare($sql);
		$query->bindParam(':lid',$did,PDO::PARAM_STR);
		$query->execute();
				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post" action="">
						...
						<div class="row">
							...
							<?php 
							if(($stats==0 AND $ad_stats==0) OR ($stats==2 AND $ad_stats==0) OR ($stats==2 AND $ad_stats==2) OR ($stats==0 AND $ad_stats==1))
							  {
