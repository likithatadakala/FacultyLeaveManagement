...
CREATE TABLE `leave_staff`.`cclmanager` ( `cclid` INT(3) NOT NULL AUTO_INCREMENT , `ccldate` VARCHAR(130) NOT NULL , `holiday` VARCHAR(150) NOT NULL , `working` VARCHAR(150) NOT NULL , `department` VARCHAR(4) NOT NULL , PRIMARY KEY (`cclid`)) ENGINE = InnoDB;
